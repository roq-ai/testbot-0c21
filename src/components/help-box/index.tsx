...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Bot Configurator'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['Server Owner', 'Server Admin', 'Server Moderator', 'Bot Configurator'];
  const addOns: string[] = ['chat', 'file'];
  const applicationName = `TestBot`;
  const tenantName = `Server`;
